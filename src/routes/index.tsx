  ...
  return <main className="paper-texture min-h-screen text-foreground">
    ...
    {!opened && <div className={`invitation-cover fixed inset-0 z-50 grid place-items-center overflow-hidden px-6 ${opening ? "is-opening" : ""}`}>
      ...
      <Button type="button" variant="envelope" onClick={enterInvitation} aria-label="Mở thiệp cưới" className="envelope-scene relative mt-12 aspect-[1.28] h-auto w-full max-w-[360px] overflow-visible border-0 bg-transparent p-0 shadow-none hover:scale-100 sm:mt-8">
        <span className="invitation-card absolute inset-x-[7%] bottom-[7%] z-10 flex aspect-[4/5] flex-col items-center overflow-hidden border border-primary/15 bg-card px-5 pt-5 text-center shadow-xl">
        ...
        <span className="envelope-shell absolute inset-x-0 bottom-0 z-20 block h-[72%] overflow-hidden film-shadow">
        ...
        <span className="envelope-flap absolute inset-x-0 top-[28%] z-30 block h-[37%] origin-top [clip-path:polygon(0_0,100%_0,50%_100%)]" />
        <span className="wax-seal absolute left-1/2 top-[63%] z-40 grid h-[4.35rem] w-[4.35rem] -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full font-display text-xl italic text-primary-foreground">M · T<span className="seal-ring absolute inset-1 rounded-full border border-primary-foreground/30" /><span className="seal-dot absolute inset-[.65rem] rounded-full border border-primary-foreground/15" /></span>
